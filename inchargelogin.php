...
<body style="color: black;background-image: url(sivam.jpeg);background-size: 100%;background-repeat: no-repeat;back">
...
<div style="position: fixed;
   ...
   color: white;
   text-align: center;">
  <h4 style="color: white;">&copy <b>Tiruvannamalai District Police 2022</b></h4>
</div>
